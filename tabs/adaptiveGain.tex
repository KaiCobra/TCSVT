...
%% Convention: best in bold, second best underlined, over the four rows.
\begin{table}[t]
\centering
...
arms). \textbf{Bold} is the best, \uline{underline} the second best. Dev set,
$n{=}560$.}
...
$h = 0.52$ & \textbf{0.782} & 0.843 & 0.1023 & 21.17 \\
$h = 0.54$ & 0.724 & 0.853 & 0.0940 & 21.73 \\
\midrule
\multicolumn{5}{l}{\textit{Adaptive threshold}}\\
$(c_{\max}, \kappa_{\max}) = (0.20, 0.60)$ (ours) & \uline{0.734} & \uline{0.856} & \uline{0.0916} & \uline{21.98} \\
$(c_{\max}, \kappa_{\max}) = (0.15, 0.55)$ (grid optimum) & 0.715 & \textbf{0.859} & \textbf{0.0890} & \textbf{22.12} \\
\midrule
