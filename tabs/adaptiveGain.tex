...
$(c_{\max}, \kappa_{\max}) = (0.15, 0.55)$ (LOCO consensus) & 0.715 & 0.859 & 0.0890 & 22.12 \\
\midrule
...
consensus @ SSIM $0.859$ & \multicolumn{4}{l}{$0.715$ vs.\ $\approx 0.677$ interpolated \quad $(+0.038)$}\\
consensus @ LPIPS $0.0890$ & \multicolumn{4}{l}{$0.715$ vs.\ $\approx 0.677$ interpolated \quad $(+0.037)$}\\
\bottomrule
\end{tabular}%
}
\end{table}
