...
arms). Following the convention used throughout this paper, \textbf{bold}
marks our reported configuration rather than the column best. Dev set,
$n{=}560$.}
...
\rowcolor{gray!12}
$(c_{\max}, \kappa_{\max}) = (0.20, 0.60)$ (ours) & \textbf{0.734} & \textbf{0.856} & \textbf{0.0916} & \textbf{21.98} \\
