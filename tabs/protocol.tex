...
\textbf{Bold} marks the selected parameters in both blocks; no per-column
ranking is marked. All values are offline estimates used for relative ranking
only --- our reported scores are those of
Table~\ref{tab:method_comparison_wo_kvedit}.}
\label{tab:protocol}
\small
\resizebox{\linewidth}{!}{%
...
\rowcolor{gray!12}
selected $(0.20, 0.60)$ & \textbf{0.734} & \textbf{0.856} & \textbf{0.0916} & \textbf{21.98} & \textbf{0.008} \\
...
\rowcolor{gray!12}
selected $(0.20, 0.60)$ & \textbf{0.657} & \textbf{0.886} & \textbf{0.0720} & \textbf{24.32} & --- \\
