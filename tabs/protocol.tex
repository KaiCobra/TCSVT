...
%% Offline evaluation (tau snapped to the nearest of 14 h-arms); relative ranking only.
\begin{table}[t]
\centering
\caption{Parameter selection. The IR-only optimum collapses to
...
\rowcolor{gray!12}
ours $(0.20, 0.60)$                         & 0.734 & 0.856 & 0.0916 & 21.98 & \textbf{0.008} \\
LOCO consensus $(0.15, 0.55)$               & 0.715 & 0.859 & 0.0890 & 22.12 & \textbf{0.000} \\
\midrule
...
\rowcolor{gray!12}
ours $(0.20, 0.60)$                         & 0.657 & 0.886 & 0.0720 & 24.32 & --- \\
LOCO consensus $(0.15, 0.55)$               & 0.637 & 0.887 & 0.0705 & 24.47 & --- \\
\bottomrule
\end{tabular}%
}
...
grid optimum; the flat region ($u \ge u_{\max} - 0.05$) covers 48\% of the
$18 \times 20$ grid.}
\end{table}
