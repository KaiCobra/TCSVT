...
%% Convention: best in bold, second best underlined, ranked within each block.
\begin{table}[t]
\centering
...
\textbf{Bold} is the best, \uline{underline} the second best, within each block.}
\label{tab:protocol}
\small
\resizebox{\linewidth}{!}{%
...
fixed $h{=}0.52$ & \uline{0.782} & 0.843 & 0.1023 & 21.17 & --- \\
fixed $h{=}0.54$ & 0.724 & 0.853 & 0.0940 & 21.73 & --- \\
IR-only optimum $(0.125, 0.05)$ \emph{(degenerate)} & \textbf{0.822} & 0.833 & 0.1102 & 20.74 & --- \\
hand-tuned $(0.33, 0.43)$ & 0.772 & 0.846 & 0.0992 & 21.44 & 0.052 \\
\rowcolor{gray!12}
ours $(0.20, 0.60)$ & 0.734 & \uline{0.856} & \uline{0.0916} & \uline{21.98} & \textbf{0.008} \\
grid optimum $(0.15, 0.55)$ & 0.715 & \textbf{0.859} & \textbf{0.0890} & \textbf{22.12} & \textbf{0.000} \\
\midrule
\multicolumn{6}{l}{\textit{Holdout: \texttt{0\_random}, $n = 140$, never used for selection}}\\
fixed $h{=}0.52$ & \textbf{0.757} & 0.873 & 0.0817 & 23.33 & --- \\
fixed $h{=}0.54$ & 0.669 & 0.879 & 0.0770 & 23.80 & --- \\
hand-tuned $(0.33, 0.43)$ & \uline{0.708} & 0.877 & 0.0788 & 23.71 & --- \\
\rowcolor{gray!12}
ours $(0.20, 0.60)$ & 0.657 & \uline{0.886} & \uline{0.0720} & \uline{24.32} & --- \\
grid optimum $(0.15, 0.55)$ & 0.637 & \textbf{0.887} & \textbf{0.0705} & \textbf{24.47} & --- \\
\bottomrule
\end{tabular}%
}
