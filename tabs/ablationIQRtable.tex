...
blocks lets positional-bias-dominated attention corrupt the mask.
\textbf{Bold} marks our configuration, as elsewhere in this paper.}
...
\midrule
\rowcolor{gray!12}
With IQR (ours) & \textbf{0.0316} & \textbf{23.44} & \textbf{0.8565} & \textbf{0.0833} & \textbf{0.2613} & \textbf{0.2290} \\
