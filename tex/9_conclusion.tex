...
the output. We also delimit the formulation: a per-case optimal threshold would
improve every metric at once, but it is not predictable from the attention
distribution or from prompt semantics, which bounds what any single-shot adaptive
rule of this family can achieve.
